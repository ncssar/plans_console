...
# terminology:
    ...
    def _sendRequest(self,type: str,apiUrlEnd: str,j: dict,id: str='',returnJson: str='',timeout: int=0,domainAndPort: str=''):
        ...
        if type=="post":
            ...
            logging.info("POST:"+str(url)+str(params))
            ...
            #DEBUG# logging.info("SENDING GET to '"+url+"'")
            # logging.info(json.dumps(paramsPrint,indent=3))
    ...
    def addAppTrack(self,
            ...
            title='New AppTrack',
            description='',
            color= '',   # SDL added color and pattern
            pattern= '',
            # cnt=None,
            # startTrack=True,
            # since=0,
        ...
        if folderId:
            jp['folderId']=folderId
        jp['description']=description
        jp['color'] = color      # SDL added color and pattern
        jp['pattern'] = pattern
        jg['type']='LineString'
        jg['coordinates']=points
        jg['incremental']=True
        ...
        if existingId:                                                     # SDL Uncommented existingId
