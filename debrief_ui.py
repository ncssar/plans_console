...
class Ui_DebriefDialog(object):
    def setupUi(self, DebriefDialog):
        ...
        self.gridLayout.addWidget(self.debriefOptionsButton, 1, 4, 2, 1)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plans_console/pause.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.debriefPauseResumeButton.setIcon(icon1)
        self.debriefPauseResumeButton.setObjectName("debriefPauseResumeButton")
        self.gridLayout.addWidget(self.debriefPauseResumeButton, 1, 3, 2, 1)
