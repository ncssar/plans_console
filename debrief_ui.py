...
class Ui_DebriefDialog(object):
    def setupUi(self, DebriefDialog):
        ...
        self.debriefStopStartButton = QtWidgets.QPushButton(DebriefDialog)
        self.debriefStopStartButton.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/plans_console/stop-icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.debriefStopStartButton.setIcon(icon1)
        self.debriefStopStartButton.setObjectName("debriefStopStartButton")
        self.gridLayout.addWidget(self.debriefStopStartButton, 1, 3, 2, 1)
...
"}")
    ...
    def retranslateUi(self, DebriefDialog):
        ...
        self.debriefStopStartButton.setToolTip(_translate("DebriefDialog", "Stop Sync"))
